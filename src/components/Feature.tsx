...
function Feature() {
  return (
<div className="max-w-6xl mx-auto font-[sans-serif] py-16">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12">
        ...
        <Settings className='mb-6 text-center w-8 mx-auto font-bold text-[#007bff]' />
        ...
        <div className="text-center">
        <ShieldCheck  className='mb-6 text-center w-8 font-bold mx-auto text-[#007bff]'/>
        ...
        <div className="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" className="w-8 mb-6 inline-block" viewBox="0 0 512.001 512.001">
        ...
        <div className="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" className="w-8 mb-6 inline-block" viewBox="0 0 24 24">
        ...
        <div className="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" className="w-8 mb-6 inline-block" viewBox="0 0 504.69 504.69">
        ...
        <div className="text-center">
          <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" className="w-8 mb-6 inline-block" viewBox="0 0 682.667 682.667">
            <defs>
              <clipPath id="a" clipPathUnits="userSpaceOnUse">
                <path d="M0 512h512V0H0Z" data-original="#000000" />
              </clipPath>
            </defs>
            <g fill="none" stroke="#007bff" strokeMiterlimit="10" strokeWidth="30" clipPath="url(#a)" transform="matrix(1.33 0 0 -1.33 0 682.667)">
